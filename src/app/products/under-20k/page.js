...
export default function ProductsUnder20k() {
    ...
    const pageConfig = {
        ...
        metaTitle: "Products Under ₹20,000 | Luxury Items Within Budget",
        metaDescription: "Shop authentic luxury items under ₹20,000. Premium brands at amazing prices.",
    ...
    const fetchProducts = useCallback(async (pageNum = 1, isLoadMore = false) => {
        try {
            ...
            console.log('📡 [UNDER 20K] Fetching products from:', apiUrl)
    ...
    useEffect(() => {
        console.log('🔄 Triggering product fetch for Under 20K')
    ...
    const filteredProducts = useMemo(() => {
        return products.filter(product => {
            ...
            // Max price filter (always 20000 for this page)
                                ...
                                <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-8 gap-4">
                                    <div>
                                        ...
                                        <p className="text-gray-600 text-sm font-light">
                                            Showing {sortedProducts.length} of {products.length} products under ₹20,000
                                            {loading && ' • Loading...'}
                                        </p>
                                    </div>
                                ...
                                {loading ? (
                                    ...
                                    sortedProducts.length === 0 ? (
                                        <div className="text-center py-12">
                                            ...
                                            <p className="text-gray-500 text-lg mb-2">No products found under ₹20,000.</p>
