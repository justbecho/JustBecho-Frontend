...
export default function ProductsUnder40k() {
    ...
    // Page Configuration for Under 40K
    const pageConfig = {
        title: "PRODUCTS UNDER ₹40K",
        subtitle: "Premium luxury items under ₹40,000",
        banner: "/banners/budget-40k.jpg",
        metaTitle: "Products Under ₹40,000 | Premium Luxury Items",
        metaDescription: "Shop authentic luxury items under ₹40,000. Premium brands at amazing prices.",
    ...
    const fetchProducts = useCallback(async (pageNum = 1, isLoadMore = false) => {
        try {
            ...
            console.log('📡 [UNDER 40K] Fetching products from:', apiUrl)
    ...
    useEffect(() => {
        console.log('🔄 Triggering product fetch for Under 40K')
    ...
    const filteredProducts = useMemo(() => {
        return products.filter(product => {
            ...
            // Max price filter (always 40000 for this page)
                                ...
                                <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-8 gap-4">
                                    <div>
                                        ...
                                        <p className="text-gray-600 text-sm font-light">
                                            Showing {sortedProducts.length} of {products.length} products under ₹40,000
                                            {loading && ' • Loading...'}
                                        </p>
                                    </div>
                                ...
                                {loading ? (
                                    ...
                                    sortedProducts.length === 0 ? (
                                        <div className="text-center py-12">
                                            ...
                                            <p className="text-gray-500 text-lg mb-2">No products found under ₹40,000.</p>
                ...
                <section className="py-12 md:py-16 bg-white">
                    <div className="max-w-7xl mx-auto px-4 sm:px-6">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            ...
                            <Link
                                href="/products/under-60k"
                                className="group relative overflow-hidden rounded-xl shadow-lg hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-1"
                            >
                                <div className="relative h-48 w-full">
                                    <Image
                                        src="/banners/budget-60k.jpg"
                                        alt="Products Under ₹60K"
                                        fill
                                        className="object-cover group-hover:scale-110 transition-transform duration-700"
                                    />
                                    <div className="absolute inset-0 bg-gradient-to-t from-black/70 via-black/30 to-transparent"></div>
