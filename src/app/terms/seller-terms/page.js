// app/terms/seller-terms/page.js - BLACK & WHITE VERSION
        ...
        <section className="w-full py-8 sm:py-12 md:py-16">
          <div className="w-full px-4 sm:px-6 lg:px-8">
            <div className="max-w-7xl mx-auto">
              {/* Introduction Box */}
              <div className="mb-8 sm:mb-12 bg-gray-50 border-l-4 border-gray-700 p-4 sm:p-6 rounded-r-lg">
                <p className="text-gray-900 font-bold text-base sm:text-lg md:text-xl mb-2">
                  SELLER TERMS & CONDITIONS
                </p>
                    ...
                    <div className="space-y-1 sm:space-y-2 max-h-[400px] overflow-y-auto pr-2">
                      {[
                        ...
                        <a
                          key={section.id}
                          href={`#${section.id}`}
                          className="block text-xs sm:text-sm text-gray-600 hover:text-black hover:bg-gray-50 p-2 rounded transition-colors"
                        >
                          {section.title}
                        </a>
                      ))}
                  ...
                  <div className="space-y-8 sm:space-y-12">
                    ...
                    <div id="section1" className="scroll-mt-32 md:scroll-mt-40">
                      <div className="flex items-center gap-3 mb-4 sm:mb-6">
                        <div className="w-8 h-8 sm:w-10 sm:h-10 bg-black text-white rounded-full flex items-center justify-center text-sm sm:text-lg font-bold">
                          1
                        </div>
                    ...
                    <div id="section3" className="scroll-mt-32 md:scroll-mt-40">
                      ...
                      <div className="flex flex-col lg:flex-row gap-4 sm:gap-6">
                        {/* Allowed Items */}
                        <div className="lg:w-1/2 bg-white border border-gray-300 rounded-lg p-4 sm:p-6 shadow-sm">
                          <div className="flex items-center gap-2 mb-3 sm:mb-4">
                            <div className="w-6 h-6 sm:w-8 sm:h-8 bg-gray-100 rounded-full flex items-center justify-center">
                              <span className="text-gray-600 font-bold text-sm sm:text-base">✓</span>
                            </div>
                            <h3 className="text-lg sm:text-xl font-bold text-gray-800">Allowed</h3>
                          </div>
                        ...
                        <div className="lg:w-1/2 bg-white border border-gray-300 rounded-lg p-4 sm:p-6 shadow-sm">
                          <div className="flex items-center gap-2 mb-3 sm:mb-4">
                            ...
                            <h3 className="text-lg sm:text-xl font-bold text-gray-800">Not Allowed</h3>
                          </div>
                          ...
                          <div className="mt-3 sm:mt-4 p-3 bg-gray-100 border border-gray-300 rounded">
                    ...
                    <div id="section4" className="scroll-mt-32 md:scroll-mt-40">
                      ...
                      <div className="bg-white border border-gray-200 rounded-lg p-4 sm:p-6 shadow-sm">
                        <div className="flex flex-col md:flex-row gap-4 sm:gap-6">
                          ...
                          <div className="md:w-1/2 bg-gray-50 border border-gray-300 rounded-lg p-3 sm:p-4">
                            <p className="text-gray-800 font-bold mb-2 text-sm sm:text-base">⚠️ Consequences:</p>
                      ...
                      <div className="bg-white border border-gray-200 rounded-lg p-4 sm:p-6 shadow-sm">
                        <div className="space-y-3 sm:space-y-4">
                          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4">
                            <div className="sm:w-1/2 p-3 sm:p-4 bg-gray-50 rounded-lg">
                              <h4 className="font-bold text-gray-800 mb-2 text-sm sm:text-base">✅ Must Do</h4>
                              <ul className="list-disc pl-4 sm:pl-6 text-gray-700 space-y-1 text-sm sm:text-base">
                            ...
                            <div className="sm:w-1/2 p-3 sm:p-4 bg-gray-100 rounded-lg">
                              <h4 className="font-bold text-gray-800 mb-2 text-sm sm:text-base">❌ Must Not</h4>
                              <ul className="list-disc pl-4 sm:pl-6 text-gray-700 space-y-1 text-sm sm:text-base">
                          ...
                          <div className="mt-4 sm:mt-6 bg-gray-100 border border-gray-300 rounded-lg p-3 sm:p-4">
                            <p className="text-gray-800 font-bold text-xs sm:text-sm">
                    ...
                    <div id="section7" className="scroll-mt-32 md:scroll-mt-40">
                      ...
                      <div className="space-y-4 sm:space-y-6">
                        <div className="flex flex-col lg:flex-row gap-4 sm:gap-6">
                          <div className="lg:w-1/2 bg-gray-50 border border-gray-300 rounded-lg p-4 sm:p-6 shadow-sm">
                            <h3 className="text-lg sm:text-xl font-bold text-gray-800 mb-3 sm:mb-4">✅ If Product Passes Inspection</h3>
                            <ul className="list-disc pl-4 sm:pl-6 text-gray-700 space-y-1 sm:space-y-2 text-sm sm:text-base">
                              <li>Product moves forward for delivery</li>
                              <li>Payment processed after buyer receipt</li>
                            </ul>
                          </div>
                          <div className="lg:w-1/2 bg-gray-100 border border-gray-300 rounded-lg p-4 sm:p-6 shadow-sm">
                            <h3 className="text-lg sm:text-xl font-bold text-gray-800 mb-3 sm:mb-4">❌ If Product Fails Inspection</h3>
                            <ul className="list-disc pl-4 sm:pl-6 text-gray-700 space-y-1 sm:space-y-2 text-sm sm:text-base">
                        ...
                        <div className="bg-gray-50 border border-gray-300 rounded-lg p-4 sm:p-6 shadow-sm">
                          <p className="text-gray-800 font-semibold mb-3 sm:mb-4 text-sm sm:text-base">
                          ...
                          <div className="grid grid-cols-1 sm:grid-cols-3 gap-2 sm:gap-3">
                            <div className="bg-white p-2 sm:p-3 rounded text-center">
                              <p className="text-gray-800 font-semibold text-xs sm:text-sm">Blacklisting</p>
                            </div>
                            <div className="bg-white p-2 sm:p-3 rounded text-center">
                              <p className="text-gray-800 font-semibold text-xs sm:text-sm">Penalties</p>
                            </div>
                            <div className="bg-white p-2 sm:p-3 rounded text-center">
                              <p className="text-gray-800 font-semibold text-xs sm:text-sm">Account termination</p>
                            </div>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="bg-white border border-gray-200 rounded-lg p-4 sm:p-6 shadow-sm">
                        <div className="text-center mb-4 sm:mb-6">
                          <p className="text-gray-700 text-base sm:text-lg font-semibold">
                            Payments released within <span className="text-gray-800 font-bold">7-14 days</span> of:
                          </p>
                        </div>
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6 mb-4 sm:mb-6">
                          <div className="bg-gray-50 p-4 sm:p-6 rounded-lg text-center">
                            ...
                            <p className="font-bold text-gray-800 text-sm sm:text-base">Product passes inspection, or</p>
                          </div>
                          <div className="bg-gray-50 p-4 sm:p-6 rounded-lg text-center">
                            <div className="w-10 h-10 sm:w-12 sm:h-12 bg-gray-100 rounded-full flex items-center justify-center mx-auto mb-3">
                              <span className="text-gray-600 text-lg sm:text-xl">📦</span>
                            </div>
                            <p className="font-bold text-gray-800 text-sm sm:text-base">Buyer receiving the Product,</p>
                          </div>
                        </div>
                    ...
                    <div id="section11" className="scroll-mt-32 md:scroll-mt-40">
                      ...
                      <div className="flex flex-col lg:flex-row gap-4 sm:gap-6">
                        <div className="lg:w-1/2 bg-white border border-gray-300 rounded-lg p-4 sm:p-6 shadow-sm">
                          <h3 className="text-lg sm:text-xl font-bold text-gray-800 mb-3 sm:mb-4">Seller's IP</h3>
                          <p className="text-gray-700 text-sm sm:text-base">
                        ...
                        <div className="lg:w-1/2 bg-white border border-gray-300 rounded-lg p-4 sm:p-6 shadow-sm">
                          <h3 className="text-lg sm:text-xl font-bold text-gray-800 mb-3 sm:mb-4">Company's IP</h3>
                          <p className="text-gray-700 mb-3 sm:mb-4 text-sm sm:text-base">
                            Seller must NOT use the Company's:
                          </p>
                          <div className="grid grid-cols-2 sm:grid-cols-2 gap-2 sm:gap-3">
                            <div className="bg-gray-100 p-2 rounded text-center">
                              <p className="text-gray-800 font-semibold text-xs sm:text-sm">Logos</p>
                            </div>
                            <div className="bg-gray-100 p-2 rounded text-center">
                              <p className="text-gray-800 font-semibold text-xs sm:text-sm">Trademarks</p>
                            </div>
                            <div className="bg-gray-100 p-2 rounded text-center">
                              <p className="text-gray-800 font-semibold text-xs sm:text-sm">Branding</p>
                            </div>
                            <div className="bg-gray-100 p-2 rounded text-center">
                              <p className="text-gray-800 font-semibold text-xs sm:text-sm">Copyrights</p>
                            </div>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="bg-white border border-gray-300 rounded-lg p-4 sm:p-6 shadow-sm">
                        ...
                        <div className="space-y-3 sm:space-y-4">
                          ...
                          <div className="bg-gray-100 border border-gray-300 rounded-lg p-3 sm:p-4">
                            <p className="text-gray-800 font-bold mb-2 text-sm sm:text-base">
                        ...
                        <div className="text-center">
                          ...
                          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
                            <div className="bg-gray-50 p-3 sm:p-4 rounded-lg">
                              <p className="font-bold text-gray-800 mb-1 text-sm sm:text-base">Email</p>
                              <p className="text-gray-700 text-xs sm:text-sm">support@justbecho.com</p>
                            </div>
                            <div className="bg-gray-50 p-3 sm:p-4 rounded-lg">
                              <p className="font-bold text-gray-800 mb-1 text-sm sm:text-base">Response Time</p>
                              <p className="text-gray-700 text-xs sm:text-sm">Within 2-3 business days</p>
                            </div>
                          </div>
                        </div>
                      </div>
                    ...
                    <div id="section18" className="scroll-mt-32 md:scroll-mt-40">
                      <div className="flex items-center gap-3 mb-4 sm:mb-6">
                        <div className="w-8 h-8 sm:w-10 sm:h-10 bg-black text-white rounded-full flex items-center justify-center text-sm sm:text-lg font-bold">
                          18
                        </div>
                    ...
                    <div id="section19" className="scroll-mt-32 md:scroll-mt-40">
                      <div className="flex items-center gap-3 mb-4 sm:mb-6">
                        <div className="w-8 h-8 sm:w-10 sm:h-10 bg-black text-white rounded-full flex items-center justify-center text-sm sm:text-lg font-bold">
                          19
                        </div>
                      ...
                      <div className="bg-white border border-gray-300 rounded-lg p-4 sm:p-6 shadow-sm">
                        <div className="text-center">
                          <div className="w-16 h-16 sm:w-20 sm:h-20 bg-gradient-to-r from-black to-gray-900 rounded-full flex items-center justify-center mx-auto mb-4 sm:mb-6">
                            <span className="text-white text-xl sm:text-2xl">✓</span>
                          </div>
                          
                          <div className="bg-gradient-to-r from-black to-gray-900 text-white p-4 sm:p-8 rounded-lg">
              ...
              <div className="flex flex-col sm:flex-row justify-between items-center mt-8 sm:mt-12 pt-6 sm:pt-8 border-t border-gray-200 gap-3 sm:gap-4">
                <Link 
                  ...
                  className="text-gray-800 hover:text-black font-semibold flex items-center gap-2 px-3 sm:px-4 py-2 border border-gray-300 rounded-lg hover:bg-gray-50 text-sm sm:text-base w-full sm:w-auto justify-center"
                >
                ...
                <div className="flex flex-col sm:flex-row items-center gap-2 sm:gap-4 w-full sm:w-auto">
                  <Link 
                    href="/privacy-policy" 
                    className="text-gray-800 hover:text-black font-semibold px-3 sm:px-4 py-2 border border-gray-300 rounded-lg hover:bg-gray-50 text-sm sm:text-base w-full sm:w-auto text-center"
                  >
                    Privacy Policy
                  </Link>
                  <Link 
