        ...
        <section className="w-full bg-gradient-to-r from-black to-gray-900 text-white">
          <div className="w-full px-4 sm:px-6 lg:px-8 py-8 md:py-16">
            <div className="max-w-7xl mx-auto text-center">
              ...
              <div className="bg-gray-800 inline-block px-4 py-2 md:px-6 md:py-2 rounded-lg mt-2 md:mt-4">
                <p className="text-gray-300 text-sm md:text-lg">Last Updated: {currentDate}</p>
              </div>
            </div>
          </div>
        </section>
                ...
                <div className="lg:col-span-3">
                  <div className="space-y-8 md:space-y-12">
                      ...
                      <div className="bg-white border border-gray-200 rounded-lg p-4 md:p-6 shadow-sm">
                        <div className="space-y-2 md:space-y-3">
                          <div className="flex items-start gap-3">
                            <span className="text-gray-900 font-bold min-w-[25px] md:min-w-[30px] text-sm md:text-base">1.1</span>
                            <p className="text-gray-700 text-sm md:text-base">
                              These Terms govern your use of the JustBecho platform and all purchases made through it.
                            </p>
                          </div>
                          <div className="flex items-start gap-3">
                            <span className="text-gray-900 font-bold min-w-[25px] md:min-w-[30px] text-sm md:text-base">1.2</span>
                            <p className="text-gray-700 text-sm md:text-base">
                              JustBecho acts solely as a marketplace facilitating transactions between Buyers and independent Sellers.
                            </p>
                          </div>
                          <div className="flex items-start gap-3">
                            <span className="text-gray-900 font-bold min-w-[25px] md:min-w-[30px] text-sm md:text-base">1.3</span>
                            <p className="text-gray-700 text-sm md:text-base">
                    ...
                    <div id="section3" className="scroll-mt-32 md:scroll-mt-40">
                      ...
                      <div className="bg-white border border-gray-200 rounded-lg p-4 md:p-6 shadow-sm">
                        <p className="text-gray-700 mb-3 md:mb-4 font-medium text-sm md:text-base">Buyers are responsible for thoroughly reviewing:</p>
                          ...
                          <div className="overflow-x-auto">
                            <table className="min-w-full bg-white border border-gray-300">
                              <thead className="bg-gray-50">
                                <tr>
                                  <th className="py-2 px-3 md:py-3 md:px-4 border-b text-left text-gray-700 font-semibold text-xs md:text-sm">Product Category</th>
                                  <th className="py-2 px-3 md:py-3 md:px-4 border-b text-left text-gray-700 font-semibold text-xs md:text-sm">Price</th>
                                  <th className="py-2 px-3 md:py-3 md:px-4 border-b text-left text-gray-700 font-semibold text-xs md:text-sm">Details</th>
                                </tr>
                              </thead>
                              <tbody>
                                <tr>
                                  <td className="py-2 px-3 md:py-3 md:px-4 border-b text-xs md:text-sm">Products below/equal to ₹15,000</td>
                                  <td className="py-2 px-3 md:py-3 md:px-4 border-b font-bold text-xs md:text-sm">₹499</td>
                                  <td className="py-2 px-3 md:py-3 md:px-4 border-b text-xs md:text-sm">Standard authentication</td>
                                </tr>
                                <tr>
                                  <td className="py-2 px-3 md:py-3 md:px-4 border-b text-xs md:text-sm">Products above ₹15,000</td>
                                  <td className="py-2 px-3 md:py-3 md:px-4 border-b font-bold text-xs md:text-sm">₹999</td>
                                  <td className="py-2 px-3 md:py-3 md:px-4 border-b text-xs md:text-sm">Premium authentication</td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                  <td className="py-2 px-3 md:py-3 md:px-4 border-b text-xs md:text-sm">Influencer collections</td>
                                  <td className="py-2 px-3 md:py-3 md:px-4 border-b font-bold text-xs md:text-sm">As mentioned</td>
                                  <td className="py-2 px-3 md:py-3 md:px-4 border-b text-xs md:text-sm">Charges as mentioned on listing page</td>
                                </tr>
                              </tbody>
                            </table>
                          </div>
                      ...
                      <div className="bg-white border border-gray-200 rounded-lg p-4 md:p-6 shadow-sm">
                        ...
                        <div className="bg-gray-50 border border-gray-300 rounded-lg p-4 md:p-6 mt-4 md:mt-6">
                          ...
                          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 md:gap-4 mb-4 md:mb-6">
                            ...
                            <div className="bg-white p-3 md:p-4 rounded-lg">
                              <p className="font-semibold text-gray-800 text-center text-xs md:text-sm">Item is significantly misrepresented</p>
                            </div>
                            <div className="bg-white p-3 md:p-4 rounded-lg">
                    ...
                    <div id="section6" className="scroll-mt-32 md:scroll-mt-40">
                      ...
                      <div className="bg-white border border-gray-300 rounded-lg p-4 md:p-6 shadow-sm">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
                          ...
                          <div>
                            <h3 className="font-bold text-gray-800 text-sm md:text-base mb-2 md:mb-4">Third-Party Gateways</h3>
                            <ul className="list-disc pl-5 md:pl-6 text-gray-700 text-xs md:text-sm space-y-1 md:space-y-2">
                    ...
                    <div id="section8" className="scroll-mt-32 md:scroll-mt-40">
                      ...
                      <div className="bg-white border border-gray-200 rounded-lg p-4 md:p-6 shadow-sm">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
                          <div>
                            <h3 className="font-bold text-gray-800 text-sm md:text-base mb-2 md:mb-4">Process</h3>
                            <ul className="list-disc pl-5 md:pl-6 text-gray-700 text-xs md:text-sm space-y-1 md:space-y-2">
                      ...
                      <div className="bg-white border border-gray-300 rounded-lg p-4 md:p-6 shadow-sm">
                        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 md:gap-4">
                          <div className="text-center p-3 md:p-4 bg-gray-50 rounded-lg">
                            ...
                            <p className="font-bold text-gray-800 text-xs md:text-sm mb-0.5 md:mb-1">Aadhaar-Verified Sellers</p>
                            <p className="text-gray-600 text-xs">Better visibility and trust ratings</p>
                          </div>
                          <div className="text-center p-3 md:p-4 bg-gray-50 rounded-lg">
                            <div className="text-xl md:text-2xl mb-1 md:mb-2">🔒</div>
                            <p className="font-bold text-gray-800 text-xs md:text-sm mb-0.5 md:mb-1">Buyer Verification</p>
                            <p className="text-gray-600 text-xs">May be required for high-value orders</p>
                          </div>
                          <div className="text-center p-3 md:p-4 bg-gray-50 rounded-lg">
                            <div className="text-xl md:text-2xl mb-1 md:mb-2">⚠️</div>
                            <p className="font-bold text-gray-800 text-xs md:text-sm mb-0.5 md:mb-1">Security Checks</p>
                            <p className="text-gray-600 text-xs">Suspicious activity may lead to order cancellation</p>
                          </div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div id="section13" className="scroll-mt-32 md:scroll-mt-40">
                      ...
                      <div className="bg-white border border-gray-200 rounded-lg p-4 md:p-6 shadow-sm">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
                          <div>
                            <h3 className="font-bold text-gray-800 text-sm md:text-base mb-2 md:mb-3">Company IP Rights</h3>
                            <ul className="list-disc pl-5 md:pl-6 text-gray-700 text-xs md:text-sm space-y-1 md:space-y-2">
                          ...
                          <div>
                            <h3 className="font-bold text-gray-800 text-sm md:text-base mb-2 md:mb-3">Buyer Restrictions</h3>
                            <ul className="list-disc pl-5 md:pl-6 text-gray-700 text-xs md:text-sm space-y-1 md:space-y-2">
                      ...
                      <div className="bg-white border border-gray-200 rounded-lg p-4 md:p-6 shadow-sm">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
                          <div className="bg-gray-50 p-3 md:p-4 rounded-lg">
                            <h3 className="font-bold text-gray-800 text-sm md:text-base mb-1 md:mb-2">Governing Law</h3>
                            <p className="text-gray-700 text-xs md:text-sm">These Terms are governed by the laws of India.</p>
                          </div>
                          <div className="bg-gray-50 p-3 md:p-4 rounded-lg">
                            <h3 className="font-bold text-gray-800 text-sm md:text-base mb-1 md:mb-2">Jurisdiction</h3>
                            <p className="text-gray-700 text-xs md:text-sm">
