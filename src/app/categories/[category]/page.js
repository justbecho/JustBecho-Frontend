...
export default async function CategoryPage({ params }) {
    try {
        // ✅ SAFE: Direct access to params (no await needed)
        const { category } = params
        ...
        // ✅ Fetch products for initial render
        const initialProducts = await fetchCategoryProducts(config.apiSlug || category, 'newest')
        
        // ✅ Calculate filters from products
        ...
        const clientProps = {
            ...
            apiCategory: config.apiSlug || category,
            config: {
                ...config,
